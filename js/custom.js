...
$(document).ready(function () {
	...
	document.getElementById('add-text').onclick = function () {
		...
		var coord = document.querySelector('#add-text').getAttribute('data-coord').split(',');
		if(coord.length > 0){
				var l = coord[0];
				var t = coord[1];
		}else{
			var l = fabric.util.getRandomInt(0, 100);
			var t = fabric.util.getRandomInt(0, 400);			
		}
...
function colorBtn(color) {
	document.querySelector("#trophyDiv").style.backgroundColor = `${color}`;
}